...
#' @description Step 1, transform BigWig files into a matrix by averaging the signals within a certain bandwidth.
#'
#' @param bw A BigWig file to be transformed.
#' @param interval An integer specifying the bandwidth used to average the bigwig signals. We set it to 200 in order to match with the state information.
#' @return A matrix with chrom name (eg. chr1), begin (eg. 201), width (eg. 200) and signal (there is only one column of signal in the output) after transformation.
#' @export
