...
#'
#' @param select_reg A vector indicating the index of rows corresponding to the orignal transformed matrix after selecing by ANOVA.
...
t_select3 <- function(select_reg, mat_anova, cell_type, state = "enhancer", alpha_2 = 0.01, m = 13, in_dir = NULL, save = TRUE, out_dir = NULL, cores = 16){
  if(is.null(in_dir)){
    in_dir = getwd()
  }
  if(is.null(out_dir)){
