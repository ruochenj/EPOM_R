...
#' @description Used in step 1 to select the corresponding regions of a specific chromatin state.
#'
#' @param gen_mat A matrix generated from function matrix_bp_trans.
#' @param bed A bed file specifying the corresponding regions for each state.
#' @param state A numeric vector indicating the chromatin states of interest.
#' @return A vector indicating the rows of the input gen_mat matrix that correspond to a state, whose region information is contained in the input bed file.
#' @export
